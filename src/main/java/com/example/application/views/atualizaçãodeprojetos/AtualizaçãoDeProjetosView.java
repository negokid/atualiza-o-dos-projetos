package com.example.application.views.atualizaçãodeprojetos;


import com.example.application.views.MainLayout;
import com.example.application.views.atualizaçãodeprojetos.ServiceHealth.Status;
...
@PageTitle("Atualização De Projetos")
@Route(value = "Atualização-de-Projetos", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class AtualizaçãoDeProjetosView extends Main {

    public AtualizaçãoDeProjetosView() {
        addClassName("atualização-de-projetos-view");
